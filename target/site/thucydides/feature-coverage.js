...
function init() {
    //init data
    var json = {"children":[{"children":[],"data":{"progress":100,"tests":1,"pending":0,"$color":"#00ff00","$area":5,"steps":5,"failing":0,"type":"tag","passing":1},"id":"login logout","name":"login logout"}],"data":{},"id":"root","name":"Application"};
    //end
    //init TreeMap
